...
<div class="mt-12 text-white space-y-8">
	...
	<section>
		...
		<LightconesBlock
  			ids={['a-greounded-ascent','but-the-battle-isnt-over','earthly-escapade','past-and-future','planetary-rendezvous','carve-the-moon-weave-the-clouds']}
	...
	<section>
		...
		<RelicsBlock
			...
			<p><span class="text-white/70">Kháng Hiệu Ứng:</span>&nbsp; <span class="font-bold">30+</span> &nbsp;<span class="text-white/70">(Vì Sunday là nhân vâtk Speed Turning tốt, nên hãy build một ít để đảm bảo rotation)</span></p>
